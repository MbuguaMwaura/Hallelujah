package com.example.hallelujah.adapters.AdminAdapters;
...
public class FirebaseChurchAdminViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    View mView;
    Context mContext;

    public FirebaseChurchAdminViewHolder(@NonNull View itemView) {
        super(itemView);
        mView = itemView;
    ...
    public void onClick(View v) {
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference("adminchurches").child(uid);
